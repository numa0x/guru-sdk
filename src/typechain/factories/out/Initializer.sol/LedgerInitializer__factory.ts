...
import type {
  LedgerInitializer,
  LedgerInitializerInterface,
} from "../../../out/Initializer.sol/LedgerInitializer";
...
export class LedgerInitializer__factory {
  static readonly abi = _abi;
  static createInterface(): LedgerInitializerInterface {
    return new Interface(_abi) as LedgerInitializerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LedgerInitializer {
    return new Contract(address, _abi, runner) as unknown as LedgerInitializer;
  }
}
