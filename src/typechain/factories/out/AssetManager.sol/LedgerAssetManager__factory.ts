...
import type {
  LedgerAssetManager,
  LedgerAssetManagerInterface,
} from "../../../out/AssetManager.sol/LedgerAssetManager";
...
export class LedgerAssetManager__factory {
  ...
  static createInterface(): LedgerAssetManagerInterface {
    return new Interface(_abi) as LedgerAssetManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LedgerAssetManager {
    return new Contract(address, _abi, runner) as unknown as LedgerAssetManager;
  }
}
