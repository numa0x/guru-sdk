...
import type {
  LedgerCooldown,
  LedgerCooldownInterface,
} from "../../../out/Cooldown.sol/LedgerCooldown";
...
export class LedgerCooldown__factory {
  ...
  static createInterface(): LedgerCooldownInterface {
    return new Interface(_abi) as LedgerCooldownInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LedgerCooldown {
    return new Contract(address, _abi, runner) as unknown as LedgerCooldown;
  }
}
