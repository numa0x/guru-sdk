...
import type {
  LedgerShares,
  LedgerSharesInterface,
} from "../../../out/Shares.sol/LedgerShares";
...
export class LedgerShares__factory {
  ...
  static createInterface(): LedgerSharesInterface {
    return new Interface(_abi) as LedgerSharesInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LedgerShares {
    return new Contract(address, _abi, runner) as unknown as LedgerShares;
  }
}
