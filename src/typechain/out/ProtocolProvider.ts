...
export interface ProtocolProviderInterface extends Interface {
...
export interface ProtocolProvider extends BaseContract {
  connect(runner?: ContractRunner | null): ProtocolProvider;
